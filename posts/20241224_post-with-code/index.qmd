...
list_of_files_v2 <- function(path, ...) {
...
list_of_files_v3 <- function(path, ...) {
...
microbenchmark(
  ...
  list_of_files_v2(path = dir_test, recursive = TRUE),
  list_of_files_v3(path = dir_test, recursive = TRUE)
) |> 
  ggplot2::autoplot()
