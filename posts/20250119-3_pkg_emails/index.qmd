...
pdb_emails_count <- length(unique(tbl_emails$email_id))
pdb_mail_servers_count <- length(unique(tbl_emails$email_domain))
pdb_tlds_count <- length(unique(tbl_emails$tld))
